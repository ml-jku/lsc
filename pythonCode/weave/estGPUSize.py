...
parser.add_argument("-methodName", help="Method name", type=str, default="weave")
...
parser.add_argument("-datasetNames", help="DatasetNames", nargs='+', type=str, default=["graphWeave"])
